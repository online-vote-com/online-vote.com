...
CREATE TABLE concours(
    ...
    etat ENUM('actif', 'inactif') NOT NULL DEFAULT 'inactif', /*validation admin*/
    type_vote ENUM('gratuit', 'payant')NOT NULL DEFAULT 'payant', 
...
/*étudier les moteurs de stockages */
...
SELECT org.nom_user AS Organisateur, cans.nom_candidat AS candidats
FROM users org, candidats cans
WHERE org.id_user = cans.id_organisateur ;
